			...
			<div class="row block-9">
				...
				<div class="col-md-4 ratting-botom ftco-animate">
					<div class="row">
						...
						<div class="col-md-12 mb-3">
							<button class="btn btn-primary py-3 px-4" data-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample1">Lịch sử đặt lịch</button>
						</div>
