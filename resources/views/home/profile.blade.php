					...
					<div class="row">
						...
						<div class="collapse" id="collapseExample{{$r->id}}">
							<div class="card card-body">
								<div class="col-md-12">
									<p><span>Ngày: </span> <span class="text-danger font-weight-normal">{{$r->reservation_date}}</span></p>
								</div>
								<div class="col-md-12">
									<p><span>Giờ: </span><span class="text-danger font-weight-normal">{{$r->timeReservation->time_reservation}}</span></p>
								</div>
								<div class="col-md-12">
									<p><span>Hair Stylist: </span> <span class="text-danger font-weight-normal">{{$r->hairStylist->name}}</span></p>
								</div>
								<div class="col-md-12">
									<p><span>Dịch vụ: </span> <span class="text-danger font-weight-normal">{{$r->service->name}}</span></p>
								</div>
								<div class="col-md-12">
									<p><span>Giá: </span> <span class="text-danger font-weight-normal">{{number_format($r->service->price).' đ'}}</span></p>
								</div>
								<div class="col-md-12">
									<p><span>Trạng Thái: </span> <span class="text-danger font-weight-normal">{{$r->status}}</span></p>
								</div>
								@php if($r->status == 'Đã Thanh Toán' && $feedback == null){
								@endphp
								<div class="col-md-12">
									<p><span>Đánh giá: </span></p>
									<form action="{{route('feedback_hair_stylist')}}" method="post">
										@csrf
										<input type="hidden" name="hair_stylist_id" value="{{$r->hair_stylist_id}}">
										...
										@if($errors)
                                            <span class="text-danger">{{$errors->first('feedback')}}</span><br>
                                        @endif
										<button type="submit" class="btn btn-primary py-3 px-4" style="margin: 30px">Gửi Đánh Giá</button>
									</form>
								</div>
