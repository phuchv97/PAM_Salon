 <footer class="ftco-footer ftco-section img">
            ...
            <div class="col-md-2">
               <div class="ftco-footer-widget mb-4 ml-md-4">
                ...
                <ul class="list-unstyled">
                  <li><a href="#" class="py-2 d-block">Cắt tóc</a></li>
                  <li><a href="#" class="py-2 d-block">Kiểu tóc</a></li>
                  <li><a href="#" class="py-2 d-block">Cắt tỉa</a></li>
                  <li><a href="#" class="py-2 d-block">Cạo râu</a></li>
                  <li><a href="#" class="py-2 d-block">Chăm sóc da</a></li>
                </ul>
              </div>
            </div>
            <div class="col-md-3">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Salon PAM</a></p>
            </div>
          </div>
        </div>
      </footer>
